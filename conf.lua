...
function love.conf(t)
	t.identity = "PongMP"				-- The name of the save directory (string)
	t.version = "0.9.2"					-- The LÖVE version this game was made for (strin
	t.console = false					-- Attach a console (boolean, Windows only)

	t.window.title = "PongMP"			-- The window title (string)
